                ...
                <div class="form-content">
                    ...
                    <form v-on:submit.prevent="changePassword">
                        <div class="field input-field">
                            <input type="email" name="email" v-model="change_password_data.email" placeholder="Your email" class="input">
                        </div>
                        <div class="field input-field">
                            <input type="password" name="password" v-model="change_password_data.password" placeholder="New Password" class="input">
                        </div>
...
<script>
    ...
    export default {
        name: 'MyLogin',
        title: 'InterPort - Reset Password',
